...
<body>
    ...
    <section class="Back_gr">
        <img data-aos="zoom-in-up" src="/template/assets/img/tour/tourpage_1.jpg">
        <div class="Back_gr_data">
            <h2 data-aos="zoom-in-up">TOURS</h2>
    ...
    <section class="tour_list">
        ...
        @endforeach
            <!-- <div class="tour_card" data-aos="zoom-in-up">
                <a href="index.html">
                    <img src="/template/assets/img/tour/tour_book12.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">My Khe Beach</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="index.html">
                    <img src="/template/assets/img/tour/tour_book11.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Cu Lao Cham</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book2.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Ba Na Hill Tourist Area</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>1 day</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book3.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Ngu Hanh Son Mountain</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book4.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Bai Buddha – Linh Ung Son Tra</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book5.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Asia Park</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book6.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Son Tra Peninsula</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book7.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Linh Ung Pagoda</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
            ...
            <div class="tour_card" data-aos="zoom-in-up">
                <a href="">
                    <img src="/template/assets/img/tour/tour_book8.jpg" class="tour_card_img">
                </a>
                <div class="tour_card_body">
                    <h1 class="tour_card_title"><a href="">Non Nuoc Beach</a></h1>
                    <div class="tour_card_info">
                        <i class="fa-solid fa-clock"></i>
                        <p>2 days 1 night</p>
                    </div>
