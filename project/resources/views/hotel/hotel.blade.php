...
<head>
    ...
    <link href="/template/assets/css/hotel.css" rel="stylesheet">
...
<body>
    ...
    <header class="section__container header__container">
        <div class="header__image__container" data-aos="zoom-in-up">
          <div class="header__content">
            <h1 data-aos="zoom-in-right">Enjoy Your Dream Vacation</h1>
            <p data-aos="zoom-in-right">Book Hotels, Flights and stay packages at lowest price.</p>
          </div>
          <div class="booking__container">
            <form>
              <div class="form__group">
                ...
                <p data-aos="zoom-in-up">Where are you going?</p>
              </div>
              <div class="form__group">
                <div class="input__group" data-aos="zoom-in-up">
                  <input type="text" />
                ...
                <p data-aos="zoom-in-up">Add date</p>
              </div>
              <div class="form__group">
                <div class="input__group" data-aos="zoom-in-up">
                  <input type="text" />
              ...
              <div class="form__group">
                ...
                <p data-aos="zoom-in-up">Add guests</p>
              </div>
            </form>
            <button data-aos="zoom-in-up" class="btn"><i class="ri-search-line"></i></button>
          </div>
        </div>
      </header>
      ...
      <section class="hotel_list">
        <h1 data-aos="zoom-in-up">Most Popular Hotels</h1>
        <div class="hotel_cover">
          @foreach($hotels as $hotel)
            <div class="hotel_card" data-aos="zoom-in-up">
                <a href="{{ route('detail_hotel', ['id' => $hotel->id]) }}">
                    <img src="{{ $hotel->thumb }}" class="hotel_card_img">
                </a>
                <div class="hotel_card_body">
                    <h1 class="hotel_card_title"><a href=""> {{ $hotel->name }}</a></h1>
                    ...
                    <div class="hotel_foot">
                        <p> ${{ $hotel->price }} <span>/ Per Night</span></p>
                    </div>
                </div>
            </div>  
          ...
          @endforeach
            ...
            <!-- <div class="hotel_card" data-aos="zoom-in-up">
                <a href="hotel_detail.html">
                    <img src="/template/assets/img/hotel/hotels_p1.jpg" class="hotel_card_img">
                </a>
                <div class="hotel_card_body">
                    <h1 class="hotel_card_title"><a href="">Muong Thanh Hotel</a></h1>
                    <div class="hotel_star">
            ...
            <div class="hotel_card" data-aos="zoom-in-up">
                <a href="hotel_detail.html">
                    <img src="/template/assets/img/hotel/hotel_book2.jpg" class="hotel_card_img">
                </a>
                <div class="hotel_card_body">
                    <h1 class="hotel_card_title"><a href="">Sel de Mer Hotel & Suites</a></h1>
                    <div class="hotel_star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="hotel_card" data-aos="zoom-in-up">
                <a href="hotel_detail.html">
                    <img src="/template/assets/img/hotel/hotels_p2.jpg" class="hotel_card_img">
                </a>
                <div class="hotel_card_body">
                    <h1 class="hotel_card_title"><a href="">Diamond Beach Hotel</a></h1>
                    <div class="hotel_star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="hotel_card" data-aos="zoom-in-up">
                <a href="hotel_detail.html">
                    <img src="/template/assets/img/hotel/hotels_p3.jpg" class="hotel_card_img">
                </a>
                <div class="hotel_card_body">
                    <h1 class="hotel_card_title"><a href="">Radisson Hotel Da Nang</a></h1>
                    <div class="hotel_star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
